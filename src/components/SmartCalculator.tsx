...
import { Plus, Save, Trash2, Sparkles, Brain, Lightbulb, AlertTriangle, CheckCircle, Zap, TrendingUp } from 'lucide-react';
...
export default function SmartCalculator() {
  ...
  // Auto-calculate metrics when rows change
  useEffect(() => {
    if (rows.length > 0) {
  ...
  const handleAIAnalysis = () => {
    if (!rows || rows.length === 0) {
      toast({
        ...
        description: 'Add ingredients to get AI analysis',
        variant: 'destructive'
      });
      return;
    }
    analyze(rows, metrics, productType);
  };
            ...
            <div className="space-y-3">
              ...
              {mlLoading ? (
                ...
                <div className="space-y-3">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xl font-bold">{prediction.score}</span>
                    </div>
                ...
                <div className="text-center py-4 text-muted-foreground">
                  ...
                  <p className="text-xs">Add ingredients for ML predictions</p>
                </div>
              )}
            </div>
            ...
            <div className="space-y-3">
              ...
              {aiLoading ? (
                ...
                <div className="space-y-3">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xl font-bold">{analysis.successScore}</span>
                    </div>
                    <Progress value={analysis.successScore} />
                    <div className="text-xs text-muted-foreground">
                      Texture: <span className="font-semibold">{analysis.texturePredict}</span>
                    </div>
                  </div>
                    ...
                    <div className="space-y-2 bg-destructive/10 p-3 rounded-lg">
                      ...
                      <ul className="space-y-1">
                        {analysis.warnings.map((warning, idx) => (
                          <li key={idx} className="text-xs text-destructive/80">• {warning}</li>
                        ))}
                      </ul>
                    </div>
                  )}
                ...
                <Button 
                  ...
                  disabled={!rows || rows.length === 0 || aiLoading}
