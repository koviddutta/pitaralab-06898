    ...
    <Card className="border-amber-200 bg-gradient-to-r from-amber-50 to-yellow-50">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-gray-700">Desired Texture</label>
        ...
        <div className="space-y-2">
          <h4 className="font-semibold text-sm text-gray-700">Sugar Spectrum Guidelines</h4>
        ...
        {optimizedBlend && (
          <div className="space-y-2 mt-4 p-3 bg-amber-100 rounded-lg">
            <h4 className="font-semibold text-sm text-amber-800 flex items-center gap-1">
            ...
            <div className="space-y-1">
              {Object.entries(optimizedBlend).map(([sugarType, amount]) => (
                <div key={sugarType} className="flex justify-between items-center text-xs">
                  <span className="text-amber-700">{sugarType}:</span>
